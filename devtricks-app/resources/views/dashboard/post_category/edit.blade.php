    ...
    <div class="card">
      <div class="card-body">
        <div class="tab-outline">
          ...
          <form action="{{asset('dashboard/post-category/edit/'.$index->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="tab-content" id="myTabContent2">
              <div class="tab-pane fade active show" id="outline-one" role="tabpanel" aria-labelledby="tab-outline-one">
                ...
                <div class="form-group">
                  <label for="slug" class="col-form-label">Slug danh mục</label>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control"  id="cat_parrent" name="cat_parrent">
                    <option value="0">Chọn danh mục</option>
                    @foreach($data as $categories)
                      @if($categories->parrent_id == $index->parrent_id && $index->parrent_id>0)
                ...
                <div class="form-group">
                  ...
                  <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
                  <div class="thumbn-image">
                    <img src="{{asset('/uploads/'.$index->image)}}" />
                  </div>
                </div>
                <div class="form-group">
                  <label for="cat_ordering" class="col-form-label">Số thứ tự</label>
                  <input id="cat_ordering" name="cat_ordering" value="{{$index->ordering}}" type="text" class="form-control">
                  @error('cat_ordering')
                  <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
                </div>
                <div class="form-group">
                  ...
                  <div class="switch-button switch-button-yesno">
                    <input type="checkbox" name="is_active"
                           @if($index->is_active==1) checked @endif
                           id="is_active"><span>
              ...
              <div class="tab-pane fade" id="outline-two" role="tabpanel" aria-labelledby="tab-outline-two">
                <div class="form-group">
                  ...
                  <input id="cat_keyword" name="cat_keyword" type="text" value="{{$index->keyword}}"  class="form-control">
                  @error('cat_keyword')
                  <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
                </div>
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="cat_description" id="cat_description" rows="4">{{$index->description}}</textarea>
